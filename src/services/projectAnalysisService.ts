...
Tech Stack: ${project.bullets?.[0] || 'Not specified'}
Description: ${project.bullets?.[1] || 'Not specified'}
Responsibilities: ${project.bullets?.[2] || 'Not specified'}
`).join('\n') || 'No projects found'}
...
        "bulletPoints": [
          "First bullet point - 20 words exactly that are relevant to the role and JD",
          "Second bullet point - 20 words exactly that are relevant to the role and JD",
          "Third bullet point - 20 words exactly that are relevant to the role and JD"
        ]
      }
    }
  ],
...
REQUIREMENTS:
1. Each bullet point must be EXACTLY 20 words - no more, no less
